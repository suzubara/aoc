import {
  ...
  findClosestIntersectionSteps,
} from './index'

describe('getAllCoords', () => {
  it('returns a list of coordinates touched by the wire', () => {
    expect(getAllCoords('R8,U5,L5,D3')).toEqual([
      [1, 0],
      [2, 0],
      [3, 0],
      [4, 0],
    ...
    expect(getAllCoords('U7,R6,D4,L4')).toEqual([
      [0, 1],
      [0, 2],
      [0, 3],
      [0, 4],
...
describe('findCommonCoords', () => {
  {
    it('returns the intersection of two sets of coords', () => {
      const testCoords1 = [
        [1, 0],
        [2, 0],
        [3, 0],
      ...
      expect(findCommonCoords(testCoords1, testCoords2)).toEqual([
        [6, 5],
        [3, 3],
      ])
    })
...
describe('getManhattanDistance', () => {
  it('returns the Manhattan distance for a coordinate', () => {
    expect(getManhattanDistance([6, 5])).toEqual(11)
    expect(getManhattanDistance([3, 3])).toEqual(6)
    expect(getManhattanDistance([-7, 3])).toEqual(10)
  })
})

describe('findSmallestDistance', () => {
  it('returns the smallest distance for a set of coordinates', () => {
    expect(
      findSmallestDistance([
        [6, 5],
        [3, 3],
...
describe('findClosestIntersection', () => {
  it('returns the closest intersection of two wires', () => {
    expect(findClosestIntersection('R8,U5,L5,D3', 'U7,R6,D4,L4')).toEqual(6)
    expect(
      findClosestIntersection(
...
describe('findClosestIntersectionSteps', () => {
  it('returns the closest intersection using number of steps', () => {
    expect(findClosestIntersectionSteps('R8,U5,L5,D3', 'U7,R6,D4,L4')).toEqual(
      30
    )
    expect(
      findClosestIntersectionSteps(
...
describe.skip('part 1', () => {
  it.skip('gets the closest intersection between 2 wires', () => {
    console.log(findClosestIntersection(wire1, wire2))
  })
})

describe('part 2', () => {
  it('gets the fastest intersection between 2 wires', () => {
    console.log('DONE', findClosestIntersectionSteps(wire1, wire2))
  })
})
